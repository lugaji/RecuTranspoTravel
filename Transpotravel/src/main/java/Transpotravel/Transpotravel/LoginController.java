...
public class LoginController implements Initializable{
    ...
    void loginBntOnAction(ActionEvent event) {
    	...
    	if(!correuLogin.getText().isBlank()&& !contrasenyaLogin.getText().isBlank()) {
    ...
    void validarLogin() {
    	...
    	String sql = "SELECT DNI FROM transpotravelrecu.usuaris where Correu = '"+correu+"' and Contrasenya = '"+contrasenya+"';";
